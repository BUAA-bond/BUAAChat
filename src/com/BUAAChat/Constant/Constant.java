...
public class Constant {
    public static final String jdbcUrl="jdbc:mysql://182.92.202.183:3306/BUAAChat";
    public static final String username="root";
    public static final String password="Buaachat123";
    public static final String host="182.92.202.183";
